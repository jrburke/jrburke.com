...
*/
define('element',['require','exports','module'],function(require, exports, module) {
...
define('app/main',['require','element'],function (require) {
...
/*jshint browser: true */
/*global define */
define('sub-header',['require'],function(require) {
    return {
...
define('template!basic-header/template.html',["element!sub-header"], function () { return {"id":"basic-header/template.html","deps":["element!sub-header"],"translateIds":true,"text":"<h1>HEADER</h1>\n<i data-prop=\"italic\" data-event=\"click\"></i>\n<div>\n  <a data-event=\"click:onSomethingClick, mouseover\" hrefid=\"./something.html\">Something</a>\n  <div>\n    <img srcid=\"./localimage.png\">\n  </div>\n</div>\n<sub-header>A sub-header</sub-header>\n"}; });

/*jshint browser: true */
/*global define */
define('basic-header/main',['require','exports','module','template!./template.html'],function(require, exports, module) {
  return {
...
define('basic-header',['basic-header/main'], function (m) {return m;});
